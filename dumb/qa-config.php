...
*/
	...
	define('QA_MYSQL_USERNAME', 'gmagigol_qtoa611');
	define('QA_MYSQL_PASSWORD', 'd6y6PSC)@1');
	define('QA_MYSQL_DATABASE', 'gmagigol_qtoa611');
...
*/
	...
	define('QA_MYSQL_TABLE_PREFIX', 'qtoa_');
