...
var markBottomLines = <?php echo json_encode(json_decode(getOption('markBottomLines'), true)); ?>;// json_encode(json_decode()) this will help empty content to hv null data
