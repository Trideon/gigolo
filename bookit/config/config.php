 ...
 */
$conf['settings']['app.title'] = 'Book a Gig';			// application title
...
$conf['settings']['admin.email'] = 'trideon@gmail.com';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://gmagigolo.com/bookit/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'gmagigol_bookit';        // database user with permission to the booked database
$conf['settings']['database']['password'] = '67M4j-P8(S';
$conf['settings']['database']['hostspec'] = 'localhost';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'gmagigol_bookit';
/**
 ...
 */
$conf['settings']['install.password'] = 'r48g4hxp';
/**
 * Pages
 */
